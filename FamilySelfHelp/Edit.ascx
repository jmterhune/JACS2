<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Edit.ascx.cs" Inherits="tjc.Modules.FamilySelfHelp.Edit" %>
...
<div id="LogEditForm">
    ...
    <div class="form-group row">
        ...
        <div class="col-3">
            <asp:Label ID="lblTimeSpent" runat="server" AssociatedControlID="txtTimeSpent">Time Spent with Person</asp:Label>
            <asp:TextBox runat="server" ID="txtTimeSpent" CssClass="form-control  form-control-sm" TextMode="Number" MaxLength="50" />
    ...
    <div class="form-group row">
        ...
        <div class="col-4">
            <asp:Label runat="server" AssociatedControlID="rblClientType" Text="Client Type" />
    ...
    <div class="row form-group">
        <div class="col-4">
            <fieldset class="fieldset-bordered d-block mb-2">
                <legend>How did they come to us?</legend>
        ...
        <div class="col-8">
            <fieldset class="fieldset-bordered d-block mb-2">
                ...
                <asp:RadioButtonList ID="rblCaseType" RepeatDirection="Vertical" RepeatLayout="UnorderedList" CssClass="radio-button-list column-4" runat="server">
                ...
                <asp:RequiredFieldValidator Display="Dynamic" SetFocusOnError="true" CssClass="label label-danger" ID="valCaseType" runat="server" ControlToValidate="rblCaseType" ErrorMessage="Selection Required"></asp:RequiredFieldValidator>
                <div class="other" id="CaseType">
                    <asp:Label ID="lblOtherCaseType" runat="server" AssociatedControlID="txtContactMethodOther">If Other Please Complete</asp:Label>
                    <asp:TextBox runat="server" CssClass="form-control form-control-sm" ID="txtCaseTypeOther" Text="Other" MaxLength="50" />
                    <asp:RequiredFieldValidator Display="Dynamic" SetFocusOnError="true" CssClass="label label-danger" ID="valCaseTypeOther" runat="server" ControlToValidate="txtCaseTypeOther" ErrorMessage="Required"></asp:RequiredFieldValidator>
                </div>
            </fieldset>
            <fieldset class="fieldset-bordered d-block">
                ...
                <asp:CustomValidator ID="valServiceProvided" runat="server" Display="Dynamic" ErrorMessage="Select at least one Value" CssClass="dnnFormMessage dnnFormError"
                ...
                <div class="other" id="ServiceProvided">
                    ...
                    <asp:CustomValidator ID="valOtherServiceProvided" ErrorMessage="Required when Other is selected above" CssClass="dnnFormMessage dnnFormError" Display="Dynamic" ClientValidationFunction="ValidateOther" OnServerValidate="valOtherServiceProvided_ServerValidate" runat="server" />
                </div>
            </fieldset>
...
<script type="text/javascript">
    ...
    function InitPage() {
        ...
        if ($('#<%=rblCaseType.ClientID%> input:radio:checked').val() == "Other") {
            $("#CaseType").fadeIn();
        }
        ...
        $("#<%=rblCaseType.ClientID%> input").change(function () {
            ...
            if (selectedValue == "Other") {
                ...
                $("#CaseType").fadeOut();
                $("#<%=txtCaseTypeOther.ClientID%>").val("Other");
            }
        });
