                    ...
                    <asp:Repeater ID="rptContact" runat="server" OnItemCreated="rptContact_ItemCreated" OnItemCommand="rptContact_ItemCommand">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="command-item">
                                    <asp:LinkButton ID="cmdDelete" CssClass="confirm" runat="server" CausesValidation="false" CommandName="delete" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"ContactID").ToString() %>'><i class="fa fa-trash"></i></asp:LinkButton>
                                </td>
                            </tr>
                        </ItemTemplate>
                        <FooterTemplate>
...
<script type="text/javascript">
    ...
    function PageInit() {
        ...
        $("#tblContact_length").prepend('<button onclick="return ClearForm()" class="btn btn-primary btn-sm me-2" data-bs-toggle="modal" data-bs-target="#EditContactModal"><i class="fa fa-plus"></i>&nbsp;Add Contact</button>');
        table.on('draw', function () {
            $(".confirm").dnnConfirm({
                text: 'Are you sure you wish to Delete the selected Contact?',
                yesText: 'Yes',
                noText: 'No',
