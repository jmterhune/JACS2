...
namespace tjc.Modules.TranscriptDatabase.Services
{
    ...
    public class DesignationListItemController : DnnApiController
    {
        ...
        public HttpResponseMessage GetDesignationListItems(int count)
        {
            ...
            string county = query.ContainsKey("county") ? query["county"] : "";
            bool archived = query.ContainsKey("archived") && Boolean.TryParse(query["archived"], out bool result) ? result : false;
            ...
            string sortColumn = "DesignationID"; // Default sort column
            ...
            try
            {
                ...
                caselistItems = ctl.GetDesignationListPaged(firstName, lastName, caseNumber, county, archived, recordOffset, pageSize, sortColumn, sortDirection)
                    .Select(designationListItem => new DesignationListItemViewModel(designationListItem)).ToList();
        ...
        public HttpResponseMessage CreateDesignation(DesignationViewModel designationViewModel)
        {
            ...
            {
                Exceptions.LogException(ex);
                return Request.CreateResponse(new DesignationResult { designationId = -1, error = ex.Message });
            }
        }
