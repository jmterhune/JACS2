...
<div class="tabs">
    ...
    <div class="tab-content pb-0">
        <asp:UpdatePanel ID="pnlStatus" runat="server" RenderMode="Block" OnUnload="pnlStatus_Unload">
            <ContentTemplate>
                                    ...
                                    <asp:Repeater runat="server" ID="rptExtensions" OnItemCommand="rptExtensions_ItemCommand" OnItemCreated="rptExtensions_ItemCreated">
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtNewDate" runat="server" MaxLength="10" Width="80" Text='<%# Eval("RequestedDate", "{0:d}")%>'
                                                        Visible='<%#!bool.Parse(Eval("Approved").ToString())%>' />
                                                    <%# bool.Parse(Eval("Approved").ToString()) ? Eval("GrantedDateFormatted") : ""%></td>
                                                <td class="command-item">
                                                    <asp:LinkButton ID="cmdApprove" runat="server" ToolTip="Approve Extension" CommandName="approve" CommandArgument='<%# Eval("ExtensionID")%>'><i class="fas fa-circle-check"></i> </asp:LinkButton>
                                                </td>
                                                <td class="command-item">
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>&nbsp;</td>
                                                <td>
                                                    <asp:TextBox AutoCompleteType="Disabled" ID="txtCompletedPages" ClientIDMode="Static" runat="server" TextMode="Number" step="1" min="0" CssClass="form-control"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                    ...
                    <div class="modal fade" id="UploadModal" tabindex="-1" role="dialog" aria-labelledby="UploadModalLabel">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer justify-content-between">
                                    <asp:Button OnClientClick="ToggleUploadForm(false)" CssClass="btn btn-primary" ID="cmdSaveFile" ValidationGroup="upload" runat="server" Text="Save" OnClick="cmdSaveFile_Click" />
                                    <button type="button" class="btn btn-default" data-bs-dismiss="modal">Close</button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal fade" id="FileSelectionModal" tabindex="-1" role="dialog" aria-labelledby="FileSelectionModalLabel">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <asp:Literal ID="ltExtensionMessage" runat="server"></asp:Literal>
                                    <div>
                                        <div>
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <asp:DropDownList ID="drpFormType" ClientIDMode="Static" runat="server" CssClass="form-control">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <div class="form-group">
                                                    <label for="txtCurrentDue">Current Due Date</label>
                                                    <asp:TextBox ID="txtCurrentDueDate" ClientIDMode="Static" runat="server" MaxLength="15" ReadOnly="true" CssClass="form-control"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox ID="txtRequestedDueDate" ClientIDMode="Static" runat="server" MaxLength="15" ReadOnly="true" CssClass="form-control"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <iframe id="ifCreateDocument" runat="server" frameborder="0" width="1" height="1" style="display: hidden" />
                                </div>
                                <div class="modal-footer justify-content-between">
                                    <asp:Button OnClientClick="ToggleFileForm(false)" CssClass="btn btn-primary" ID="cmdSave" ValidationGroup="FileSelection" runat="server" Text="Save" OnClick="cmdSave_Click" />
                                    <button type="button" class="btn btn-default" data-bs-dismiss="modal">Close</button>
                                </div>
                            </div>
                        </div>
            ...
            <Triggers>
                <asp:AsyncPostBackTrigger ControlID="cmdUpdateDueDate" EventName="Click" />
                <asp:AsyncPostBackTrigger ControlID="cmdUpdateTranscriptFiled" EventName="Click" />
                <asp:AsyncPostBackTrigger ControlID="cmdSaveEvent" EventName="Click" />
                <asp:AsyncPostBackTrigger ControlID="cmdSaveFile" EventName="Click" />
...
<script type="text/javascript">
    ...
    const uploadHandler = "<%=UploadAttachmentFolder%>";
    ...
    var extensionDocTypes = [{ id: 3, name: "Extension Request" }];
    var serviceEmployee = {
            ...
            if (filteredOptions.length > 0) {
                ...
                filteredOptions.forEach(option => {
                    ...
                    div.on('click', function () {
                        ...
                        $('#selectedEditorId').val(option.nameid)
