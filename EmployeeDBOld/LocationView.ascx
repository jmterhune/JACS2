...
<script type="text/javascript">
    ...
    function PageInit() {
        ...
        $(".dt-length").prepend('<button class="btn btn-primary btn-sm me-2" data-bs-toggle="modal" data-bs-target="#EditOfficeLocationModal"><i class="fa fa-plus"></i>&nbsp;Add Location</button>');
        table.draw();
