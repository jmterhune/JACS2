...
<script type="text/javascript">
    ...
    function PageInit() {
        ...
        $(".dt-length").prepend('<button onclick="return ClearForm(1)" class="btn btn-primary btn-sm me-2" data-bs-toggle="modal" data-bs-target="#EditPositionHistoryModal"><i class="fa fa-plus"></i>&nbsp;Add Postion History</button>');
        table.draw();
        ...
        $(".dt-length").prepend('<button onclick="return ClearForm(0)" class="btn btn-primary btn-sm me-2" data-bs-toggle="modal" data-bs-target="#EditServiceHistoryModal"><i class="fa fa-plus"></i>&nbsp;Add Service History</button>');
        table2.draw();
