<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ReferralReview.ascx.cs" Inherits="tjc.Modules.CourtCounsel.ReferralReview" %>
        ...
        <div class="accordion" id="referral">
            <div class="card card-default">
                <div class="card-header">
                    <h4 class="card-title">
                        <a class="accordion-toggle" data-toggle="collapse" data-parent="#referral" href="#collapse1One">Judicial Referral Information</a>
                    </h4>
                </div>
                    ...
                    <div class="card-body">
                        <fieldset disabled>
                            <div class="row form-group">
                                <div class="col-auto">
                                    <asp:Label runat="server" AssociatedControlID="txtReferralJudge" Text="Judge" />
                                    <asp:TextBox ID="txtReferralJudge" runat="server" MaxLength="25" CssClass="form-control"></asp:TextBox>
                                </div>
                                <div class="col-auto">
                                    <asp:Label runat="server" AssociatedControlID="txtReferralCaseNumber" Text="Case Number" />
                                    <asp:TextBox ID="txtReferralCaseNumber" runat="server" MaxLength="25" CssClass="form-control upperCase"></asp:TextBox>
                                </div>
                                <div class="col-auto">
                                    <asp:Label runat="server" AssociatedControlID="txtReferralCaseParties" Text="Case Name" />
                                    <asp:TextBox ID="txtReferralCaseParties" runat="server" MaxLength="2000" CssClass="form-control" placeholder="Party One v. Party Two"></asp:TextBox>
                                </div>
                                <div class="col-auto">
                                    <asp:Label runat="server" AssociatedControlID="txtReferralCaseType" Text="Case Type" />
                                    <asp:TextBox ID="txtReferralCaseType" runat="server" MaxLength="25" CssClass="form-control"></asp:TextBox>
                                </div>

                                <div class="col-auto">
                                    <asp:Label runat="server" AssociatedControlID="txtReferralMotionTitle" Text="Motion Title" />
                                    <asp:TextBox ID="txtReferralMotionTitle" runat="server" MaxLength="50" CssClass="form-control"></asp:TextBox>
                                </div>
                                <div class="col-auto">
                                    <asp:Label runat="server" AssociatedControlID="txtReferralMotionDate" Text="Motion Date" />
                                    <asp:TextBox runat="server" CssClass="form-control" ID="txtReferralMotionDate" />
                                </div>
                            </div>
                        </fieldset>
                        <fieldset>
                        ...
                        <div>
                            <asp:Literal ID="ltMotions" runat="server" />
                        </div>
                    </div>
                </div>
            </div>
        </div>
        <h4 class="mt-2">Court Counsel Record</h4>
        <div class="row form-group">
            <div class="col-md-5">
...
<script>
    ...
    function PageInit() {
        ...
        $("#drpCounty").on("change", function () {
            ...
            var county = $(this).val();
            if ((county == 1 && caseCounty != "D") || (county == 3 && caseCounty != "M") || (county == 2 && (caseCounty != "S" || caseCounty != "V"))) {
        ...
        $("#txtDefendantSuffix").on("blur", function () {
            var valCntl = document.getElementById('<%=valCaseNumber.ClientID%>');
    ...
    function RetrieveLogEntryByCaseNumber(caseNumber) {
        ...
        try {
            ...
            ShowAlert("Error Requesting Records!!", "Unexpected error searching for case number.\n\nMake sure you are logged in and try again");//No Case Found
        }
        return false;
    }
