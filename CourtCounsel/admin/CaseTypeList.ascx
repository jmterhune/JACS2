<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CaseTypeList.ascx.cs" Inherits="tjc.Modules.CourtCounsel.CaseTypeList" %>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title" id="EditCaseTypeModalLabel">Add / Edit Case Types</h4>
