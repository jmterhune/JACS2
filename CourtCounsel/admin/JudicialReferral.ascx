...
<script>
    (function ($, Sys) {
        $(document).ready(function () {
            ...
            $("#table-referrals_length").prepend('<button class="btn btn-primary me-2" data-bs-toggle="modal" data-bs-target="#searchModal"><i class="fa fa-search"></i>&nbsp;Search All Referrals</button>');
        });
    }(jQuery, window.Sys));
