...
<script type="text/javascript">
    ...
    function PageInit() {
        ...
        $("#tblMember_length").prepend('<button onclick="return ClearForm()" class="btn btn-primary btn-sm me-2" data-bs-toggle="modal" data-bs-target="#EditMemberModal"><i class="fa fa-plus"></i>&nbsp;Add Member</button>');
