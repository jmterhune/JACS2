<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CategoryView.ascx.cs" Inherits="tjc.Modules.jacs.CategoryView" %>
...
<div class="modal fade" id="CategoryDetailModal" tabindex="-1" aria-labelledby="CategoryDetailModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div id="progress-category" class="modal-progress" style="display: none;">
                ...
                <table class="table table-striped m-0 p-0 w-100">
                    <tbody>
                        <tr>
                            ...
                            <td><span id="catDescription"></span></td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div class="modal-footer justify-content-around">
                <button type="button" class="btn btn-primary" data-bs-dismiss="modal" data-bs-toggle="modal" data-bs-target="#CategoryEditModal" id="editCategoryBtn"><i class="fas fa-edit me-2"></i>&nbsp;Edit</button>
...
<div class="modal fade" id="CategoryEditModal" tabindex="-1" aria-labelledby="CategoryEditModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div id="edit_progress-category" class="modal-progress" style="display: none;">
                <div class="center-progress">
                    <img alt="" src="/images/loading.gif" />
                </div>
            </div>
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <input type="hidden" id="edit_hdCategoryId">
        ...
        $(document).ready(function () {
            try {
                if (typeof CategoryController === 'undefined') {
                    console.error('CategoryController is not defined. Check if Script(category.js) loaded correctly.');
                    return;
                }
                ...
                console.error('Error initializing CategoryController:', e);
            }
        });
    }(jQuery, window.Sys));
</script>
