...
namespace tjc.Modules.MediationStatistics
{
    ...
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class EditFamilyPreFile : MediationStatisticsModuleBase
    {
        #region Members
        private readonly INavigationManager _navigationManager;
        private int _regionId = Null.NullInteger;
        private readonly GroupType _caseTypeGroup = GroupType.FamilyPreFile;
        ...
        private void InitializeDropDowns()
        {
            ...
            IEnumerable<Issue> issues = ctlCaseType.GetIssuesByGroup((int)_caseTypeGroup);
        ...
        private void FillCase()
        {
            ...
            if (CaseID <= 0)
            {
                ...
                Response.Redirect(EditUrl("cid", _currentCase.CaseId.ToString(), "FamilyPreFile"), true);
            }
            else
            {
        ...
        private void CheckExistingCase()
        {
            ...
            if (result != null && result.Count() > 0)
            {
                ...
                Response.Redirect(EditUrl("cid", caseid.ToString(), "FamilyPreFile"), true);
            }
        }
        #endregion
        #region Events
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    lnkCancel.NavigateUrl = EditUrl("cid", CaseID.ToString(), "FamilyPreFile");
                    ...
                    lnkNew.NavigateUrl = EditUrl("rid", _regionId.ToString(), "FamilyPreFile");
        ...
        {
            var stringValue = Localization.GetString("Alert.Text", LocalResourceFile.Replace("FamilyPreFile", ""));
            if (CaseID <= 0)
            {
                CheckExistingCase();
        ...
        protected void lstEvents_ItemInserted(object sender, ListViewInsertedEventArgs e)
        {
            ...
            {
                Response.Redirect(EditUrl("cid", CaseID.ToString(), "FamilyPreFile", "sidx=" + CurrentSessionIndex), true);
            }
        }
