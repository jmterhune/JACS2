...
namespace tjc.Modules.MediationStatistics
{
    ...
    /// 
    /// Because the control inherits from MediationStatisticsSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : MediationStatisticsModuleSettingsBase
    {
        ...
        public override void LoadSettings()
        {
            try
            {
                if (Page.IsPostBack == false)
                {
                    ...
                    if (TabModuleSettings.Contains("AdminRole"))
                        drpAdminRole.SelectedValue = Convert.ToString(TabModuleSettings["AdminRole"]);
