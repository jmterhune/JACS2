                ...
                <div class="row">
                    ...
                    <div class="col-auto">
                        <div class="mb-3">
                            ...
                            <asp:TextBox AutoCompleteType="Disabled" runat="server" ID="txtPetitionerName" ClientIDMode="Static" Enabled="false" CssClass="form-control" />
                    ...
                    <div class="col-auto">
                        <div class="mb-3">
                            ...
                            <asp:TextBox AutoCompleteType="Disabled" runat="server" ID="txtPetitionerEmail" ClientIDMode="Static" Enabled="false" CssClass="form-control" />
                        </div>
                    </div>
                    <div class="col-auto">
                        <div class="mb-3">
                            <asp:Label runat="server" AssociatedControlID="txtPetitionerPhone" Text="Phone" />
                            <asp:TextBox AutoCompleteType="Disabled" runat="server" ID="txtPetitionerPhone" ClientIDMode="Static" Enabled="false" CssClass="form-control" />
                        </div>
                    </div>
                    <div class="col-auto">
                        <div class="mb-3">
                            <asp:Label runat="server" AssociatedControlID="txtPetitionerExtension" Text="Extension" />
                            <asp:TextBox AutoCompleteType="Disabled" runat="server" ID="txtPetitionerExtension" ClientIDMode="Static" Enabled="false" CssClass="form-control" />
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-auto">
                        <div class="mb-3">
                            ...
                            <asp:TextBox AutoCompleteType="Disabled" runat="server" ID="txtRespondentName" ClientIDMode="Static" Enabled="false" CssClass="form-control" />
                        </div>
                    </div>
                    <div class="col-auto">
                        <div class="mb-3">
                            <asp:Label runat="server" AssociatedControlID="txtRespondentEmail" Text="Email Address" />
                            <asp:TextBox AutoCompleteType="Disabled" runat="server" ID="txtRespondentEmail" ClientIDMode="Static" Enabled="false" CssClass="form-control" />
                        </div>
                    </div>
                    <div class="col-auto">
                        <div class="mb-3">
                            <asp:Label runat="server" AssociatedControlID="txtRespondentPhone" Text="Phone" />
                            <asp:TextBox AutoCompleteType="Disabled" runat="server" ID="txtRespondentPhone" ClientIDMode="Static" Enabled="false" CssClass="form-control" />
                        </div>
                    </div>
                    <div class="col-auto">
                        <div class="mb-3">
                            <asp:Label runat="server" AssociatedControlID="txtRespondentExtension" Text="Extension" />
                            <asp:TextBox AutoCompleteType="Disabled" runat="server" ID="txtRespondentExtension" ClientIDMode="Static" Enabled="false" CssClass="form-control" />
                        </div>
                    </div>
                    <div class="col-auto pt-4">
                ...
                <div class="row">
                    ...
                    <div class="col-auto">
                        <div class="mb-3">
                            ...
                            <asp:TextBox AutoCompleteType="Disabled" runat="server" ID="txtOrderReferral" TextMode="Date" MaxLength="15" ClientIDMode="Static" CssClass="form-control" />
                        </div>
                    </div>
                    <div class="col-auto">
                        <div class="mb-3">
                            <asp:Label runat="server" AssociatedControlID="txtMediationDate" Text="Mediation Date / Resolved" />
                            <asp:TextBox AutoCompleteType="Disabled" runat="server" ID="txtMediationDate" TextMode="Date" MaxLength="15" ClientIDMode="Static" CssClass="form-control" />
                        </div>
                    </div>
                </div>
                <div class="row mt-3">
                            ...
                            <div class="row">
                                <div class="col-auto">
                                    <div class="mb-3">
                                        ...
                                        <%#Convert.ToBoolean(Eval("MediationHeld").ToString())?"":"<div class='row'><div class='col-12'><div class='mb-3'><label class='form-label'>Reason Not Held:</label> <span id='txtReasonNotHeld'>" + Eval("ReasonNotHeld", "{0:d}") + "</span></div></div></div>"%>
                                    </div>
                                </div>
                                <div class="col-auto">
                                    <div class="mb-3">
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <button type="button" class="btn-close" onclick="CloseEventModal(event)" aria-label="Close"></button>
                        </div>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <button type="button" class="btn-close" onclick="CloseAttorneyModal(event)" aria-label="Close"></button>
                        </div>
                        <div class="modal-body mb-3">
                            <div class="row mb-3">
                                <div class="col-auto">
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <button type="button" class="btn-close" onclick="CloseMediatorModal(event)" aria-label="Close"></button>
                        </div>
                        <div class="modal-body mb-3">
                            <div class="row mb-3">
                                <div class="col-auto">
