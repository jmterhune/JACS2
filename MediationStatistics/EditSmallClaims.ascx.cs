...
namespace tjc.Modules.MediationStatistics
{
    ...
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class EditSmallClaims : MediationStatisticsModuleBase
    {
        #region Members
        private readonly INavigationManager _navigationManager;
        private int _regionId = Null.NullInteger;
        private GroupType _caseTypeGroup = GroupType.SmallClaims;
        ...
        private void FillCase()
        {
            ...
            if (CaseID <= 0)
            {
                ...
                Response.Redirect(EditUrl("cid", _currentCase.CaseId.ToString(), "SmallClaims"), true);
            }
            else
            {
            ...
            if (_currentCase.CaseId >= 0)
            {
                ...
                session.PTC_CourtOrdered = rblPtcOrdered.SelectedValue;
        ...
        private void CheckExistingCase()
        {
            ...
            if (result != null && result.Count() > 0)
            {
                ...
                Response.Redirect(EditUrl("cid", caseid.ToString(), "SmallClaims"), true);
            }
        }
        #endregion
        #region Events
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    lnkCancel.NavigateUrl = EditUrl("cid", CaseID.ToString(), "SmallClaims");
                    ...
                    lnkNew.NavigateUrl = EditUrl("rid", _regionId.ToString(), "SmallClaims");
        ...
        {
            var stringValue = Localization.GetString("Alert.Text", LocalResourceFile.Replace("SmallClaims", ""));
            if (CaseID <= 0)
            {
                CheckExistingCase();
        ...
        protected void lstEvents_ItemInserted(object sender, ListViewInsertedEventArgs e)
        {
            ...
            {
                Response.Redirect(EditUrl("cid", CaseID.ToString(), "SmallClaims", "sidx=" + CurrentSessionIndex), true);
            }
        }
