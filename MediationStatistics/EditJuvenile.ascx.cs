...
namespace tjc.Modules.MediationStatistics
{
    ...
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class EditJuvenile : MediationStatisticsModuleBase
    {
        #region Members
        private readonly INavigationManager _navigationManager;
        private int _regionId = Null.NullInteger;
        private readonly GroupType _caseTypeGroup = GroupType.Juvenile;
        ...
        private void FillCase()
        {
            ...
            if (CaseID <= 0)
            {
                ...
                Response.Redirect(EditUrl("cid", _currentCase.CaseId.ToString(), "Juvenile"), true);
            }
            else
            {
        ...
        private void CheckExistingCase()
        {
            ...
            if (result != null && result.Count() > 0)
            {
                ...
                Response.Redirect(EditUrl("cid", caseid.ToString(), "Juvenile"), true);
            }
        }
        #endregion
        #region Events
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    lnkCancel.NavigateUrl = EditUrl("cid", CaseID.ToString(), "Juvenile");
                    ...
                    lnkNew.NavigateUrl = EditUrl("rid", _regionId.ToString(), "Juvenile");
        ...
        {
            var stringValue = Localization.GetString("Alert.Text", LocalResourceFile.Replace("Juvenile", ""));
            if (CaseID <= 0)
            {
                CheckExistingCase();
        ...
        protected void lstEvents_ItemInserted(object sender, ListViewInsertedEventArgs e)
        {
            ...
            {
                Response.Redirect(EditUrl("cid", CaseID.ToString(), "Juvenile", "sidx=" + CurrentSessionIndex), true);
            }
        }
