...
<script type="text/javascript">
    ...
    function PageInit() {
        ...
        $("#tblJobGroups_length").prepend('<button class="btn btn-primary btn-lg me-2" data-bs-toggle="modal" data-bs-target="#EditJobGroupModal"><i class="fa fa-plus"></i>&nbsp;Add Job Category</button>');
        table.draw();
