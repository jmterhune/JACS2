...
<script type="text/javascript">
    ...
    function PageInit() {
        ...
        $("#tblJobGroups_length").prepend('<button class="btn btn-primary btn-lg mr-2" data-toggle="modal" data-target="#EditJobGroupModal"><i class="fa fa-plus"></i>&nbsp;Add Job Category</button>');
        table.draw();
