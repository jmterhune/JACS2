...
<script type="text/javascript">
    ...
    function PageInit() {
        ...
        $("#tblJobClasses_length").prepend('<button class="btn btn-primary btn-sm me-2" data-bs-toggle="modal" data-bs-target="#EditJobClassModal"><i class="fa fa-plus"></i>&nbsp;Add Job Class </button>');
        table.draw();
