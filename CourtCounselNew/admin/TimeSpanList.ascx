...
<script type="text/javascript">
    ...
    function PageInit() {
        ...
        $(".dt-length").prepend('<button onclick="return ClearForm()" class="btn btn-primary btn-sm me-2" data-bs-toggle="modal" data-bs-target="#EditTimeSpanModal"><i class="fa fa-plus"></i>&nbsp;Add Time Span</button>');
