        ...
        <nav class="navbar navbar-expand-lg navbar-filters mb-0 pb-0 pt-0">
            ...
            <div class="collapse navbar-collapse" id="bp-filters-navbar">
                <ul class="nav navbar-nav">
                    ...
                    <li filter-name="courtroom" filter-type="select2" filter-key="courtroomId" class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu p-0">
                            <div class="form-group backpack-filter mb-0">
                                <select id="courtroomFilter" name="courtroomFilter" class="form-control input-sm select2" placeholder="-" data-filter-key="courtroomId" data-filter-type="select2" data-filter-name="courtroom" data-language="en" data-filter-enabled="true">
                                    <option value="">-</option>
                                </select>
                            </div>
                        </div>
