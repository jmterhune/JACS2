...
' are accessible to your module's controls (that inherity from PowerShellModuleBase
' 
' </summary>

Public Class PowerShellModuleBase
    Inherits PortalModuleBase
    Public ReadOnly Property ScriptFolder As String
        Get
            If (Settings.Contains("ScriptFolder")) Then
                Return Settings("ScriptFolder").ToString()
            End If
            Return ""
        End Get
    End Property
