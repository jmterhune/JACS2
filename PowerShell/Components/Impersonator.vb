...
Public Class Impersonator
    ...
    Private Const LOGON32_LOGON_NEW_CREDENTIALS As Int32 = 9
    Private mImpersonationContext As WindowsImpersonationContext = Nothing
    ...
    Private Sub impersonateValidUser(ByVal userName As String, ByVal domain As String, ByVal password As String)
        ...
        Try
            If RevertToSelf() Then
                Dim loggedResult As Integer = LogonUser(userName, domain, password, LOGON32_LOGON_NEW_CREDENTIALS, LOGON32_PROVIDER_DEFAULT, token)
                If loggedResult <> 0 Then
    ...
    Private Sub undoImpersonation()
        If mImpersonationContext IsNot Nothing Then
