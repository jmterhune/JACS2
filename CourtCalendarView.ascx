                    ...
                    <div class="tabs mb-0">
                        ...
                        <div class="tab-content">
                            ...
                            <div id="eventTab" class="tab-pane fade form-group mb-0">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <label id="plaintiff_label" class="plaintiff_label">Plaintiff</label>
                                        <input type="text" id="event_plaintiff" class="form-control" autocomplete="off">
                                    </div>
                                    <div class="col-md-6">
                                        <label id="defendant_label" class="defendant_label">Defendant</label>
                                        <input type="text" id="event_defendant" class="form-control" autocomplete="off">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <label id="plaintiff_email_label" class="plaintiff_email_label">Plaintiff Email</label>
                                        <input type="email" id="event_plaintiffEmail" class="form-control" autocomplete="off">
                                    </div>
                                    <div class="col-md-6">
                                        <label id="defendant_email_label" class="defendant_email_label">Defendant Email</label>
                                        <input type="email" id="event_defendantEmail" class="form-control" autocomplete="off">
                                    </div>
                                </div>
                                <div class="row" id="court_template_fields"></div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <label>Notes</label>
