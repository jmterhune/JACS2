// Filename: js/courtextend.js
(function ($, Sys) {
    function CourtExtendController(config) {
        ...
        function submitExtendForm() {
            ...
            $.ajax({
                url: '/DesktopModules/JACS/API/CourtAPI/ExtendCalendar',
                type: 'GET',
                headers: {
                    'ModuleId': config.moduleId,
                    'TabId': config.service.getTabId(),
                    'RequestVerificationToken': config.service.getAntiForgeryValue()
                },
                data: {
                    courtId: courtId,
                    startDate: startDate,
    ...
    window.CourtExtendController = CourtExtendController;
}(jQuery, window.Sys));