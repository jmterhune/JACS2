...
namespace tjc.Modules.PretrialServices
{
    partial class PretrialReport : System.Web.UI.Page
    {
        ...
        private string CountyName = "Sarasota";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["cid"] != null)
                Int32.TryParse(Request.QueryString["cid"].ToString(), out CountyId);
            ...
            string reportHeader = string.Format("{0} County Board of County Commissioners Pretrial Services", CountyName);
            ...
            if (reportType == ReportType.daily)
            {
                ...
                reportName = string.Format("pts-CRTK-{0}-{1}-{2}-{3}.pdf", CountyId, reportDate.Month.ToString(), reportDate.Day.ToString(), reportDate.Year.ToString());
            ...
            else if (reportType == ReportType.yearly)
            {
                ...
                reportName = string.Format("pts-CRTK-Yearly-{0}-{1}-{2}.pdf", CountyName, reportDate.Month.ToString(), reportDate.Year.ToString());
                PdfWriter pdfWriter1 = PdfWriter.GetInstance(doc, new FileStream(appPath + reportName, FileMode.Create));
                pdfWriter1.PageEvent = PageEventHandler;
                pdfWriter1.SetFullCompression();
                pdfWriter1.StrictImageSequence = true;
