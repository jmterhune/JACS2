        ...
        <div class="modal-content p-3">
            ...
            <div class="modal-header mb-2">
                ...
                <div class="tab-pane active" id="timeslotTab" role="tabpanel" aria-labelledby="timeslot-tab">
                    <div id="timeslotForm" data-action="">
                        ...
                        <div class="row time-selection">
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="time" name="timeslot_start" id="timeslot_start" class="form-control" required step="300" />
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="time" name="timeslot_end" id="timeslot_end" class="form-control" required step="300" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 text-end">
                                <button type="button" class="btn btn-primary" id="saveTimeslotBtn">Save changes</button>
                            </div>
                        </div>
                    </div>
                </div>
