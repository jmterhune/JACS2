        ...
        <ItemTemplate>
            <tr>
                ...
                <td class="command-icon">
                    <asp:LinkButton runat="server" ID="cmdDelted" CssClass="text-danger confirm item-link" CommandName="delete" CommandArgument='<%#Eval("OrderID") %>'><i class="fas fa-trash"></i></asp:LinkButton></td>
                </td>
            </tr>
            <tr class="border-0">
