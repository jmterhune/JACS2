...
<div class="supply-order-container">
            ...
            <asp:Repeater ID="rptSupplies" runat="server" OnItemCommand="rptSupplies_ItemCommand" OnItemDataBound="rptSupplies_ItemDataBound">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td><%#Eval("Comments") %></td>
                        <td>
                            <asp:LinkButton runat="server" CausesValidation="false" ID="cmdDeleted" CssClass="confirm" CommandName="delete" CommandArgument='<%#Eval("SupplyId") %>'><i class="fa fa-trash" aria-hidden="true"></i></asp:LinkButton>
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <fieldset id="Supply-item" class="row g-3">
                            ...
                            <div class="col-md-6">
                                <asp:Label runat="server" CssClass="form-label" AssociatedControlID="txtUnitsOfMeasure" Text="Unit of Measure" />
