...
namespace tjc.Modules.Purchasing
{
    ...
    /// 
    /// Because the control inherits from PurchasingSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : PurchasingModuleSettingsBase
    {
        ...
        public override void LoadSettings()
        {
            try
            {
                if (Page.IsPostBack == false)
                {
                    ...
                    {
                        txtEmails.Text = Settings["Emails"].ToString();
                    }
        ...
        public override void UpdateSettings()
        {
            try
            {
                ...
                objModules.UpdateModuleSetting(ModuleId, "AttachmentFolderName", txtAttachmentFolderName.Text);
            }
