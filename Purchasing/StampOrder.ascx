    ...
    <div id="stamp-form">
        <fieldset class="row mb-3">
            ...
            <div class="col-md-4 col-lg-3">
                <asp:Label runat="server" ID="lblFontStyle" CssClass="form-label" AssociatedControlID="drpFontStyle" Text="Font Style<em>*</em>" />
            ...
            <div class="col-md-4 col-lg-3">
                <asp:Label runat="server" ID="lblFontSize" CssClass="form-label" AssociatedControlID="txtFontSize" Text="Font Size<em>*</em>" />
            ...
            <div class="col-md-4 col-lg-3">
                <asp:Label runat="server" ID="lblInkColor" CssClass="form-label" AssociatedControlID="drpInkColor" Text="Ink Color<em>*</em>" />
            ...
            <div class="col-md-5">
                ...
                <asp:TextBox ID="txtSample" runat="server" MaxLength="2000" TextMode="MultiLine" Rows="4" CssClass="sample form-control text-center"></asp:TextBox>
