<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Edit.ascx.cs" Inherits="tjc.Modules.Purchasing.Edit" %>
<%@ Register TagPrefix="dnn" TagName="label" Src="~/controls/LabelControl.ascx" %>
<div class="stamp-form-container">
    <div class="row g-3" id="referral-form">
        <div class="col-md-6">
        ...
        <div class="col-md-6">
            <asp:Label runat="server" CssClass="form-label" AssociatedControlID="txtSample" Text="Stamp Text" />
            <asp:TextBox ID="txtSample" runat="server" MaxLength="50" CssClass="form-control"></asp:TextBox>
        ...
        <div class="col-md-6">
            ...
            <asp:TextBox ID="txtFontSize" runat="server" MaxLength="50" CssClass="form-control"></asp:TextBox>
